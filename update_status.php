...
//service price update
if (isset($_POST['question_id']) && isset($_POST['new_status'])) {
    $question_id = $_POST['question_id'];
    $new_status = $_POST['new_status'];

    // Update the service status in the tbl_services table
    $update_services_sql = "UPDATE tbl_prebuild_questions SET status = ? WHERE prequestion_id = ?";
    $stmt_services = $conn->prepare($update_services_sql);
    $stmt_services->bind_param("si", $new_status, $question_id);
